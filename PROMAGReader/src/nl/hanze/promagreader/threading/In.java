...
public class In extends Thread {
	...
	private void convertBufferToString() {
		...
		for(int i=0;i<max;i++) {
			switch(buffer[i]) {
				case 0x02 : stbTemp.append(""); break;
				case 0x07 : stbTemp.append(""); break;
				case 0x0A : stbTemp.append(""); break;
				case 0x0D : stbTemp.append(""); break;
				case 0x1B : stbTemp.append(""); break;
